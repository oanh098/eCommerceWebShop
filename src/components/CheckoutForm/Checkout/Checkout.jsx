...
import { Paper, Stepper, Step,
    StepLabel, Typography, CircularProgress, Divider,
    Button, CssBaseline } from '@material-ui/core';
...
const Checkout = ({ cart, order, handleCaptureCheckout, error }) => {
    ...
    let Confirmation = () => order.customer ? (
        ...
        <CssBaseline />
            <div>
                <Typography variant='h5'>Thank you for purchase, {order.customer.firstname},
